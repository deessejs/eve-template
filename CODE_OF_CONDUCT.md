...
pull requests, Discussions, and any other channel where this project is
discussed — and also applies when an individual is officially representing the
...
channels listed in [`SUPPORT.md`](./SUPPORT.md). All complaints will be reviewed
